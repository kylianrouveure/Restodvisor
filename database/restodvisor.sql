...
# Temps de génération: 2023-11-08 15:54:22 +0000
# ************************************************************
...
# Affichage de la table aliments
# ------------------------------------------------------------

DROP TABLE IF EXISTS `aliments`;

CREATE TABLE `aliments` (
  `ID_aliment` int(3) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `aliments` (`ID_aliment`, `Nom_aliment`, `ID_type_allergene`)
VALUES
	(1,'Gin',10),
	(2,'Vodka',0),
	(3,'Vermouth',1),
...
# Affichage de la table allergene
# ------------------------------------------------------------

DROP TABLE IF EXISTS `allergene`;

CREATE TABLE `allergene` (
  `ID_allergène` int(2) NOT NULL AUTO_INCREMENT,
  `Nom_allergène` varchar(44) DEFAULT NULL,
  PRIMARY KEY (`ID_allergène`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `allergene` WRITE;
/*!40000 ALTER TABLE `allergene` DISABLE KEYS */;

INSERT INTO `allergene` (`ID_allergène`, `Nom_allergène`)
VALUES
	(1,'Sans allergène'),
	(2,'Gluten'),
	(3,'Lactose'),
...
CREATE TABLE `avis` (
  `id_avis` int(2) NOT NULL AUTO_INCREMENT,
  ...
  KEY `id_eta` (`id_eta`),
  KEY `id_user` (`id_user`),
  CONSTRAINT `avis_ibfk_1` FOREIGN KEY (`id_eta`) REFERENCES `etablissement` (`ID_eta`),
  CONSTRAINT `avis_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `avis` WRITE;
/*!40000 ALTER TABLE `avis` DISABLE KEYS */;

INSERT INTO `avis` (`id_avis`, `avis`, `note`, `id_eta`, `id_user`)
VALUES
	(1,'Très bon',4,2,12),
...
# Affichage de la table eta_plats
# ------------------------------------------------------------

DROP TABLE IF EXISTS `eta_plats`;
...
CREATE TABLE `eta_plats` (
  ...
  KEY `ID_eta` (`ID_eta`),
  KEY `ID_plat` (`ID_plat`),
  CONSTRAINT `eta_plats_ibfk_1` FOREIGN KEY (`ID_eta`) REFERENCES `etablissement` (`ID_eta`),
  CONSTRAINT `eta_plats_ibfk_2` FOREIGN KEY (`ID_plat`) REFERENCES `plats` (`Id_plat_boisson`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `eta_plats` WRITE;
/*!40000 ALTER TABLE `eta_plats` DISABLE KEYS */;

INSERT INTO `eta_plats` (`ID_eta`, `ID_plat`)
VALUES
	(3,7),
	(4,46),
	(1,21),
...
/*!40000 ALTER TABLE `eta_plats` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `etablissement` (
  `ID_eta` int(2) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`ID_eta`),
  KEY `ID_type` (`ID_type`),
  KEY `id_specialites_plats` (`id_specialites_plats`),
  CONSTRAINT `etablissement_ibfk_1` FOREIGN KEY (`ID_type`) REFERENCES `type_eta` (`ID_type_eta`),
  CONSTRAINT `etablissement_ibfk_2` FOREIGN KEY (`id_specialites_plats`) REFERENCES `spécialités` (`Id_specialités`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `etablissement` WRITE;
/*!40000 ALTER TABLE `etablissement` DISABLE KEYS */;

INSERT INTO `etablissement` (`ID_eta`, `Nom_eta`, `Adresse_eta`, `Code_postal_eta`, `numero_eta`, `ID_type`, `Horaires`, `id_specialites_plats`, `capacite`, `id_user_proprio`, `GPS_X`, `GPS_Y`, `mobilité reduite`)
VALUES
	(1,'La Mère Léa.','1 Rue Hugues Guerin',69008,789539111,2,'10h30 - 22h30',14,600,5,45.716329,4.992807,'Oui'),
	(2,'L\'Acteur.','2 Rue Hugues Guerin',69008,789539112,2,'11h30 - 14h30',7,400,9,45.730426,4.884724,'Oui'),
	(3,'La Mère Brazier.','3 Rue Hugues Guerin',69008,789539113,1,'11h00 - 22h00',2,300,10,45.781556,4.865206,'Oui'),
...
CREATE TABLE `plats` (
  `Id_plat_boisson` int(2) NOT NULL AUTO_INCREMENT,
  `Nom_plat_boisson` varchar(20) DEFAULT NULL,
  `Id_type_plat` int(1) DEFAULT NULL,
  `Prix` int(2) DEFAULT NULL,
  PRIMARY KEY (`Id_plat_boisson`),
  KEY `Id_type_plat` (`Id_type_plat`),
  CONSTRAINT `plats_ibfk_1` FOREIGN KEY (`Id_type_plat`) REFERENCES `type_plats` (`ID_type_plats`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `plats` WRITE;
/*!40000 ALTER TABLE `plats` DISABLE KEYS */;

INSERT INTO `plats` (`Id_plat_boisson`, `Nom_plat_boisson`, `Id_type_plat`, `Prix`)
VALUES
	(1,'Canard laqué',1,22),
...
# Affichage de la table plats_aliments
# ------------------------------------------------------------

DROP TABLE IF EXISTS `plats_aliments`;

CREATE TABLE `plats_aliments` (
  `ID_plats` int(2) DEFAULT NULL,
  `ID_Aliments` int(3) DEFAULT NULL,
  KEY `ID_plats` (`ID_plats`),
  KEY `ID_Aliments` (`ID_Aliments`),
  CONSTRAINT `plats_aliments_ibfk_1` FOREIGN KEY (`ID_plats`) REFERENCES `plats` (`Id_plat_boisson`),
  CONSTRAINT `plats_aliments_ibfk_2` FOREIGN KEY (`ID_Aliments`) REFERENCES `aliments` (`ID_aliment`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `plats_aliments` WRITE;
/*!40000 ALTER TABLE `plats_aliments` DISABLE KEYS */;

INSERT INTO `plats_aliments` (`ID_plats`, `ID_Aliments`)
VALUES
	(39,79),
	(1,95),
	(10,36),
...
/*!40000 ALTER TABLE `plats_aliments` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `reservation` (
  `id_reservation` int(2) NOT NULL AUTO_INCREMENT,
  ...
  KEY `id_user_resa` (`id_user_resa`),
  KEY `id_etat_resa` (`id_etat_resa`),
  CONSTRAINT `reservation_ibfk_1` FOREIGN KEY (`id_user_resa`) REFERENCES `user` (`id_user`),
  CONSTRAINT `reservation_ibfk_2` FOREIGN KEY (`id_etat_resa`) REFERENCES `etablissement` (`ID_eta`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `reservation` WRITE;
/*!40000 ALTER TABLE `reservation` DISABLE KEYS */;

INSERT INTO `reservation` (`id_reservation`, `date`, `heure`, `nombre_ind`, `id_etat_resa`, `id_user_resa`)
VALUES
...
# Affichage de la table spécialités
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spécialités`;

CREATE TABLE `spécialités` (
  `Id_specialités` int(2) NOT NULL AUTO_INCREMENT,
  `Nom_spécialité` varchar(11) DEFAULT NULL,
  PRIMARY KEY (`Id_specialités`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `spécialités` WRITE;
/*!40000 ALTER TABLE `spécialités` DISABLE KEYS */;

INSERT INTO `spécialités` (`Id_specialités`, `Nom_spécialité`)
VALUES
	(1,'Chinois'),
	(2,'Grec'),
	(3,'Italien'),
...
/*!40000 ALTER TABLE `spécialités` ENABLE KEYS */;
UNLOCK TABLES;


# Affichage de la table type_eta
# ------------------------------------------------------------

DROP TABLE IF EXISTS `type_eta`;

CREATE TABLE `type_eta` (
  `ID_type_eta` int(1) NOT NULL AUTO_INCREMENT,
  `Nom_eta` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`ID_type_eta`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `type_eta` WRITE;
/*!40000 ALTER TABLE `type_eta` DISABLE KEYS */;

INSERT INTO `type_eta` (`ID_type_eta`, `Nom_eta`)
VALUES
	(1,'Bar'),
	(2,'Restaurant');

/*!40000 ALTER TABLE `type_eta` ENABLE KEYS */;
UNLOCK TABLES;


# Affichage de la table type_plats
# ------------------------------------------------------------

DROP TABLE IF EXISTS `type_plats`;

CREATE TABLE `type_plats` (
  `ID_type_plats` int(1) NOT NULL AUTO_INCREMENT,
  `Type_plat` varchar(7) DEFAULT NULL,
  PRIMARY KEY (`ID_type_plats`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `type_plats` WRITE;
/*!40000 ALTER TABLE `type_plats` DISABLE KEYS */;

INSERT INTO `type_plats` (`ID_type_plats`, `Type_plat`)
VALUES
	(1,'Plat'),
	(2,'Entree'),
	(3,'Dessert'),
...
/*!40000 ALTER TABLE `type_plats` ENABLE KEYS */;
UNLOCK TABLES;


# Affichage de la table type_user
# ------------------------------------------------------------

DROP TABLE IF EXISTS `type_user`;

CREATE TABLE `type_user` (
  `id_type_user` int(1) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `type_user` (`id_type_user`, `type_user`)
VALUES
	(1,'Client'),
	(2,'Restaurateur');
...
CREATE TABLE `user` (
  ...
  CONSTRAINT `user_ibfk_1` FOREIGN KEY (`id_type_user`) REFERENCES `type_user` (`id_type_user`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `user` WRITE;
/*!40000 ALTER TABLE `user` DISABLE KEYS */;

INSERT INTO `user` (`id_user`, `id_type_user`, `nom_user`, `prenom_user`, `image_user`, `mail_user`, `age_user`, `mobile_user`, `gps_x`, `gps_y`, `mobilite_reduite`)
VALUES
	(1,1,'Martin','Emma','resource/image/user/template3.png','emmamartin@gmail.com',20,674732751,'49,063001','4,341981','Oui'),
	(2,1,'Dubois','Léa','resource/image/user/template2.png','maelysdubois123@yahoo.com',42,658120540,'48,374956','-0,380053','Non'),
	(3,1,'Beranrd','Lucas','resource/image/user/template3.png','nathanthomas789@yahoo.com',64,688650291,'44,644282','-1,487261','Non'),
	(4,1,'Thomas','Hugo','resource/image/user/template.png','inessimon932@hotmail.com',35,729850170,'48,970098','1,470314','Non'),
	(5,2,'Robert','Chloé','resource/image/user/template2.png','chloeleroy754@gmail.com',46,752534756,'47,617908','0,524959','Non'),
	(6,1,'Petit','Camille','resource/image/user/template.png','lucasmartinez256@example.com',64,628001713,'45,713167','3,358311','Non'),
	(7,1,'Richard','Nathan','resource/image/user/template3.png','hugorobert327@yahoo.com',98,730452419,'44,170568','1,789004','Non'),
	(8,1,'Moreau','Manon','resource/image/user/template2.png','lisalambert421@hotmail.com',62,617779141,'45,65813','1,439749','Non'),
	(9,2,'Laurent','Théo','resource/image/user/template3.png','camilledupont555@gmail.com',24,612649961,'49,130546','1,71344','Non'),
	(10,2,'Garcia','Inès','resource/image/user/template.png','enzobernard876@example.com',53,678338513,'46,359261','4,259464','Non'),
	(11,1,'Martinez','Noé','resource/image/user/template3.png','emmanguyen678@hotmail.com',53,723012157,'48,765094','4,244422','Non'),
	(12,1,'Lefebvre','Lisa','resource/image/user/template2.png','tommorreau789@gmail.com',24,648292606,'49,968263','3,883325','Non'),
	(13,1,'Leroy','Enzo','resource/image/user/template.png','jaderichard876@example.com',54,784088161,'44,424006','-2,625958','Non'),
	(14,1,'Simo ','Sarah','resource/image/user/template.png','lolapetit234@yahoo.com',75,677615498,'47,707383','-2,907977','Non'),
	(15,1,'Mathieu','Jade','resource/image/user/template3.png','sarahgarcia111@gmail.com',42,722402583,'45,770542','3,757591','Non'),
	(16,2,'Lemoine','Louis','resource/image/user/template2.png','noemathieu789@example.com',64,759125150,'48,72009','2,012423','Non'),
	(17,1,'Durand','Maelys','resource/image/user/template2.png','theolefebvre555@hotmail.com',35,643292596,'44,55098','-0,847703','Non'),
	(18,2,'Dupont','Tom','resource/image/user/template2.png','manonlaurent432@gmail.com',24,759859834,'45,30821','4,872884','Non'),
	(19,1,'Lambert','Lola','resource/image/user/template3.png','ethandurand123@example.com',46,684679981,'46,075171','2,54898','Non'),
	(20,2,'Nguyen','Ethan','resource/image/user/template2.png','leamartin333@yahoo.com',46,606419987,'44,824783','2,183356','Non');
